...
export class ProductService {productsUrl : string = "http://localhost:8750/SpringMVC/Produit";
  ...
  getAllProduits() : Observable<Produit[]>{
    return this.myhttp.get<Produit[]>(this.productsUrl+"/retrieve-all-produits");
  }
